            ...
            <div className="flex flex-col gap-4 mt-4">
              ...
              <ul className="flex flex-col gap-3 text-xs md:text-sm font-light text-muted list-none pl-0">
                <li className="flex gap-4 border-l border-keel pl-4">
                  <span className="font-mono text-accent font-medium">2022-Present</span>
                  <span>Ph.D. Candidate in Electronics, Information, and Communication Engineering, Kangwon National University</span>
                </li>
                <li className="flex gap-4 border-l border-keel pl-4">
